<template>
  <section class="my-10 md:my-24 text-center">
    ...
    <p>Previously, I founded a <a href="https://brandcrowd.com" target="_blank">start-up</a> (sold in 2011), was Director of Product at <a href="https://venturelab.org/" target="_blank">VentureLab</a>, helped build ZippyKid (now <a href="https://pressable.com" target="_blank">Pressable</a>), was a mentor for [Techstars](http://techstars.com) Cloud, and spent a few years trying to make a living as a freelance designer.</p>
  </section>
</template>
