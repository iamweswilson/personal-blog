<template>
  <section class="about-text my-10 md:my-24 text-center">
    ...
    <p>
      I'm a recovering entrepreneur and designer driving business outcomes across product, web and marketing. I also occassionally dabble in front-end development.</p>
    <p>
      Currently, I am Director of Product for the newly relaunched <a href="https://openinfra.dev" target="_blank">OpenInfra Foundation</a> (previously OpenStack Foundation). We build communities who write open source software that runs in production, including OpenStack that powers some of the most critical infrastructure in the world (CERN, Walmart, Tencent, and Blizzard to name a few).</p>
